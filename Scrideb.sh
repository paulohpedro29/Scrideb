...
function InformacoesSistema(){
  ...
  then
      echo "$senha1" | sudo -S apt-get install neofetch -y
      clear
  fi
...
function menu_navegadores(){
    ...
    echo -e '\e[31;1m [' 5 '] \e[m Qupzilla.------------------(Open Source)'
	echo
...
Qupzilla(){
    if ! [ -x /usr/bin/Qupzilla ]
    then
        clear
        echo "Instalando Qupzilla"
        echo "******************"
        echo
        echo "$senha1" | sudo -S apt-get install qupzilla -y
        echo "$senha1" | sudo -S apt-get install -f -y --force-yes
        echo
        if [ -x /usr/bin/qupzilla ]
        then
          echo "==> Qupzilla Está Instalado!"
        else
          echo "xxx> O Qupzilla Não Foi Instalado!"
        fi
    else
        echo
        echo "O Qupzilla Já Está Instalado!"
    fi
    echo
    echo
    echo
...
function InformacoesScript(){
	...
	echo
	echo
	echo "Se houver dúvidas ou sugestões, contate-nos pelo E-mail: paulohpedro73@gmail.com"
	echo
	echo
	echo
	echo "Pressione ENTER para retornar ao Menu Principal ..."
...
function Sair(){
    ...
    do
	    ...
	    echo "             *        de Pacotes foi Criado Por Paulo Henrique.       *"
	    echo "             *                                                        *"
	    echo "             **********************************************************"
	    echo
	    echo
	    echo
	    echo
	    echo -e '\e[32;1mObrigado por utilizar meu Script :)!\e[m'
	    echo
	    echo
	    echo
